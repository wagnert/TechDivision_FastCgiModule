...
/**
 * \TechDivision\FastCgiModule\FastCgiClient
 *
 * NOTICE OF LICENSE
 *
...
/**
 * This is the Fast-CGI connection handler.
 *
 * @category  Library
 * @package   TechDivision_FastCgiModule
 * @author    Tim Wagner <tw@techdivision.com>
...
class FastCgiClient
{
    ...
    /**
     * Sets the Fast-CGI host to connect to.
     * 
    ...
    /**
     * Sets the Fast-CGI port to connect to.
     * 
    ...
    public function wait_for_response($requestId, $timeoutMs = 0) {
        ...
        if (!is_array($resp)) {
            ...
            if ($info['unread_bytes'] == 0
                    && $info['blocked']
                    && $info['eof']) {
                throw new ForbiddenException(var_export($resp, true));
            }
