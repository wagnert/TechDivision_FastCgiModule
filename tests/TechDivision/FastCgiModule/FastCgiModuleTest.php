...
use TechDivision\FastCgiModule\Mock\FastCgiMockModule;
...
class FastCgiModuleTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testProcess()
    {
        ...
        $mockFastCgiModule = $this->getMock('TechDivision\FastCgiModule\FastCgiModule', array('getFastCgiClient'));
        ...
        $mockHttpRequest = $this->getMockForAbstractClass('TechDivision\Http\HttpRequestInterface');
        ...
        $mockRequestContext = $this->getMockForAbstractClass('TechDivision\Server\Interfaces\RequestContextInterface');
        ...
        $mockHttpResponse = $this->getMockForAbstractClass('TechDivision\Http\HttpResponseInterface');
